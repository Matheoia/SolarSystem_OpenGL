...
int main()
{
    ...
    while(glfwGetKey(window, GLFW_KEY_ESCAPE) != GLFW_PRESS && !glfwWindowShouldClose(window)){
        ...
        jupiter.position.x = -160.0f * cos(currentTime * 2.0f * glm::pi<float>() / 4328.9f + 0.9f);
        jupiter.position.z = -160.0f * sin(currentTime * 2.0f * glm::pi<float>() / 4328.0f + 0.9f);
        ...
        saturne.position.x = 280.0f * cos(currentTime * 2.0f * glm::pi<float>() / 10752.9f - 2.0f);
        saturne.position.z = 280.0f * sin(currentTime * 2.0f * glm::pi<float>() / 10752.9f - 2.0f);
        ...
        anneauSaturne.position.x = 280.0f * cos(currentTime * 2.0f * glm::pi<float>() / 10752.9f - 2.0f);
        anneauSaturne.position.z = 280.0f * sin(currentTime * 2.0f * glm::pi<float>() / 10752.9f - 2.0f);
        ...
        uranus.position.x = -580.0f * cos(currentTime * 2.0f * glm::pi<float>() / 30660.0f - 1.07f);
        uranus.position.z = -580.0f * sin(currentTime * 2.0f * glm::pi<float>() / 30660.0f - 1.07f);
        ...
        neptune.position.x = 880.0f * cos(currentTime * 2.0f * glm::pi<float>() / 61243.35f + 1.07f);
        neptune.position.z = 880.0f * sin(currentTime * 2.0f * glm::pi<float>() / 61243.35f + 1.07f);
